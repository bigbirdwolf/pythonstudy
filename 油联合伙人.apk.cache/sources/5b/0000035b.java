    ...
    */
    private static android.graphics.Typeface loadFont(@android.support.annotation.NonNull android.content.Context r14, android.content.res.Resources r15, android.util.TypedValue r16, int r17, int r18, @android.support.annotation.Nullable android.support.v4.content.res.ResourcesCompat.FontCallback r19, @android.support.annotation.Nullable android.os.Handler r20, boolean r21) {
        ...
        L24:
            return r12
        L25:
            android.graphics.Typeface r1 = android.support.v4.graphics.TypefaceCompat.findFromCache(r15, r4, r5)
            if (r1 == 0) goto L31
            if (r9 == 0) goto L30
        ...
        L31:
            ...
            android.support.v4.content.res.FontResourcesParserCompat$FamilyResourceEntry r2 = android.support.v4.content.res.FontResourcesParserCompat.parse(r1, r15)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.XmlPullParserException -> L8e
            if (r2 != 0) goto L54
            ...
            if (r9 == 0) goto L53
            r9.callbackFailAsync(r13, r10)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.XmlPullParserException -> L8e
        L53:
            return r12
        L54:
            r1 = r14
            ...
            r7 = r20
            r8 = r21
            android.graphics.Typeface r0 = android.support.v4.graphics.TypefaceCompat.createFromResourcesFamilyXml(r1, r2, r3, r4, r5, r6, r7, r8)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.XmlPullParserException -> L8e
            return r0
        L65:
            r1 = r14
            android.graphics.Typeface r0 = android.support.v4.graphics.TypefaceCompat.createFromResourcesFontFile(r14, r15, r4, r11, r5)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.XmlPullParserException -> L8e
            if (r9 == 0) goto L75
            if (r0 == 0) goto L72
            r9.callbackSuccessAsync(r0, r10)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.XmlPullParserException -> L8e
            goto L75
        L72:
            r9.callbackFailAsync(r13, r10)     // Catch: java.io.IOException -> L76 org.xmlpull.v1.XmlPullParserException -> L8e
        L75:
