    ...
    public static void main(String[] strArr) throws IOException {
        ...
        while (it.hasNext()) {
            ...
            if (next.tagName().equals("img")) {
                print(" * %s: <%s> %sx%s (%s)", next.tagName(), next.attr("abs:src"), next.attr(SocializeProtocolConstants.WIDTH), next.attr(SocializeProtocolConstants.HEIGHT), trim(next.attr("alt"), 20));
            } else {
