...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    public String getColumnsAlignmentRepresentation() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (verticalSlice.alignment == 1) {
                ...
                str = str + OfflineResource.VOICE_FEMALE;
    ...
    public String getColumnAlignmentRepresentation(int i) {
        VerticalSlice verticalSlice = this.mVerticalSlices.get(i);
        return verticalSlice.alignment == 1 ? "L" : verticalSlice.alignment == 0 ? "C" : verticalSlice.alignment == 3 ? OfflineResource.VOICE_FEMALE : verticalSlice.alignment == 2 ? "R" : "!";
    }
