...
public class MessageHomeAdapter extends BaseQuickAdapter<HomeGoodsResponse, BaseViewHolder> {
    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.chad.library.adapter.base.BaseQuickAdapter
    public void convert(BaseViewHolder baseViewHolder, HomeGoodsResponse homeGoodsResponse) {
    }

    public MessageHomeAdapter(@Nullable List<HomeGoodsResponse> list) {
        super(R.layout.adapter_message_home, list);
    }
}