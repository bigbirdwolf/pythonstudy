...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            correctTopRightRectangular = correctTopRightRectangular(resultPoint12, resultPoint11, resultPoint13, resultPoint, i, i2);
            if (correctTopRightRectangular == null) {
                correctTopRightRectangular = resultPoint;
            }
            int transitions3 = transitionsBetween(resultPoint2, correctTopRightRectangular).getTransitions();
            int transitions4 = transitionsBetween(resultPoint11, correctTopRightRectangular).getTransitions();
            if ((transitions3 & 1) == 1) {
                transitions3++;
            }
            int i3 = transitions3;
            ...
            sampleGrid = sampleGrid(this.image, resultPoint2, resultPoint12, resultPoint11, correctTopRightRectangular, i3, transitions4);
        } else {
            correctTopRightRectangular = correctTopRight(resultPoint12, resultPoint11, resultPoint13, resultPoint, Math.min(i2, i));
            if (correctTopRightRectangular == null) {
                correctTopRightRectangular = resultPoint;
            }
            int max = Math.max(transitionsBetween(resultPoint13, correctTopRightRectangular).getTransitions(), transitionsBetween(resultPoint11, correctTopRightRectangular).getTransitions()) + 1;
            if ((max & 1) == 1) {
                max++;
            }
            int i4 = max;
            sampleGrid = sampleGrid(this.image, resultPoint13, resultPoint12, resultPoint11, correctTopRightRectangular, i4, i4);
            resultPoint2 = resultPoint13;
        }
        return new DetectorResult(sampleGrid, new ResultPoint[]{resultPoint2, resultPoint12, resultPoint11, correctTopRightRectangular});
    }
