...
final class PopupMenuDismissOnSubscribe implements Observable.OnSubscribe<Void> {
    ...
    public void call(final Subscriber<? super Void> subscriber) {
        ...
        PopupMenu.OnDismissListener onDismissListener = new PopupMenu.OnDismissListener() { // from class: com.jakewharton.rxbinding.support.v7.widget.PopupMenuDismissOnSubscribe.1
