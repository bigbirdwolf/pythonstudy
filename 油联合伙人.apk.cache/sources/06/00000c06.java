...
public final class GenericRequest<A, T, Z, R> implements Request, SizeReadyCallback, ResourceCallback {
    ...
    private void onResourceReady(Resource<?> resource, R r) {
        ...
        if (this.requestListener == null || !this.requestListener.onResourceReady(r, (A) this.model, this.target, this.loadedFromMemoryCache, isFirstReadyResource)) {
    ...
    public void onException(Exception exc) {
        ...
        if (this.requestListener == null || !this.requestListener.onException(exc, (A) this.model, this.target, isFirstReadyResource())) {
