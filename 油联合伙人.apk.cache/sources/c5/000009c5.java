...
public class a {
    ...
    /* loaded from: classes.dex */
    public class AlertDialogC0008a extends AlertDialog {
        /* JADX INFO: Access modifiers changed from: protected */
        public AlertDialogC0008a(Context context) {
            super(context);
        }
        ...
        private View a(Context context) {
            ...
            textView.setText(TextUtils.isEmpty(a.this.g) ? a.a : a.this.g);
