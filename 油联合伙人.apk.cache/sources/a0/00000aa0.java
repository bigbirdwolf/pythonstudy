...
public class LunarCalendar {
    ...
    public static final int[] solarToLunarDeprecated(int i, int i2, int i3) {
        ...
        if (leapMonth != 0 && i8 > leapMonth) {
            i8--;
            Log.i("----------->", i + HelpFormatter.DEFAULT_OPT_PREFIX + i2 + HelpFormatter.DEFAULT_OPT_PREFIX + i3 + "====>" + i8 + HelpFormatter.DEFAULT_OPT_PREFIX + leapMonth);
            if (i8 == leapMonth) {
                i5 = 1;
            }
        }
    ...
    private static long solarToInt(int i, int i2, int i3) {
        int i4 = (i2 + 9) % 12;
        int i5 = i - (i4 / 10);
        return (((i5 * 365) + (i5 / 4)) - (i5 / 100)) + (i5 / HttpStatusCodes.CODE_400) + (((i4 * 306) + 5) / 10) + (i3 - 1);
    }
}