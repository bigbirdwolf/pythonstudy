...
class NeuQuant {
    ...
    public void learn() {
        ...
        int i11 = 2048;
        while (i7 < i3) {
            int i12 = (bArr[i8 + 0] & 255) << 4;
            int i13 = (bArr[i8 + 1] & 255) << 4;
            int i14 = (bArr[i8 + 2] & 255) << 4;
            int contest = contest(i12, i13, i14);
            altersingle(i9, contest, i12, i13, i14);
            if (i10 != 0) {
                alterneigh(i10, contest, i12, i13, i14);
            }
            i8 += i;
            if (i8 >= i2) {
                i8 -= this.lengthcount;
            ...
            if (i7 % i6 == 0) {
                ...
                for (int i16 = 0; i16 < i15; i16++) {
                    int i17 = i15 * i15;
                    this.radpower[i16] = (((i17 - (i16 * i16)) * 256) / i17) * i9;
                }
                i10 = i15;
            }
        }
