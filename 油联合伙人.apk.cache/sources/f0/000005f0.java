                    ...
                    while (true) {
                        if (i2 < pointerCount2) {
                            ...
                            if (pointerId5 != this.mActivePointerId) {
                                i = (findTopChildUnder((int) motionEvent.getX(i2), (int) motionEvent.getY(i2)) == this.mCapturedView && tryCaptureViewForDrag(this.mCapturedView, pointerId5)) ? this.mActivePointerId : -1;
                            }
                            i2++;
                        }
                    }
